...
There is a polynomial time constant-factor approximation to the indefinite quadratic programming if the matrix of quadratic coefficients $Q$ has a constant number of negative eigenvalues \autocite{vavasis92}.
